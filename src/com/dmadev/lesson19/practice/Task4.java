...
//Сложить два многочлена заданной степени, если коэффициенты многочлена хранятся в обьекте HashMap в виде:
//ключ: номер степени
//Значение:значение множителя
//Вывести результирующий многочлен в виде строки: ах^6 + bx^4+cx^3+dx+8
...
public class Task4 {
    ...
    public static Map<Integer,Integer> sum(Map<Integer,Integer> polynom1,Map<Integer,Integer> polynom2){
        Map<Integer, Integer> polynomialResult = new HashMap<>(polynom1);
        for (Map.Entry<Integer, Integer> entry : polynom2.entrySet()) {
